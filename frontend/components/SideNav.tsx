      ...
      <div className="w-80 sm:w-64 flex-shrink-0 bg-card p-4 border-r border-border flex flex-col h-full">
         <div>
             <Link to="/app/home" onClick={onClose} className="flex items-center mb-8 group">
                 <div className="p-1 bg-primary-600 rounded-lg mr-3 group-hover:bg-primary-700 transition-colors">
            ...
            className="h-14 w-14 object-contain" // Adjusted size slightly to match typical navbar proportions better
        />
                 </div>
